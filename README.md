...
### Running RECUR in a Docker Container
  ...
  ```
  docker container run -it --rm -v $(pwd)/MyData:/usr/src/RECUR/MyData:Z orthofinder/recur:v1.0.0 -f MyData/my_alignment.aln -st AA --outgroups MyData/my_alignment.outgroups.txt
  ```
